...
export const NEWS: NewsArticle[] = [
  {
    ...
    excerpt:
      "Cập nhật 17.09.2026: The Camellia Sơn Trà đã hoàn thiện phần móng - hầm và đang thi công phần thân theo thông tin đã công bố. Bộ ảnh công trường hiện tại không có bổ sung mới.",
    ...
    body: [
      ...
      {
        heading: "Cập nhật 17.09.2026",
        text: "Ngày 17.09.2026: site chưa nhận thêm ảnh công trường mới so với bộ ảnh đã đăng. Trạng thái công bố vẫn giữ nguyên — móng - hầm đã hoàn thiện, phần thân đang thi công; bàn giao dự kiến 2028 theo thông tin dự án. Khi có ảnh hoặc cột mốc mới được xác nhận, bài này sẽ được bổ sung.",
      },
      {
  ...
  },
  {
    ...
    excerpt:
      "So sánh nhanh Studio, 1PN+1 và 2PN tại The Camellia Sơn Trà (469 căn, giá từ 1,98 tỷ). Ai nên chọn loại nào — rồi inbox Zalo 0934 885 108 để rà giỏ hàng.",
    image: "/images/news-gio-hang-studio-og.jpg",
    poster: "/images/news-gio-hang-studio.webp",
    gallery: [
      "/images/news-gio-hang-studio.webp",
    ...
    body: [
      {
        text: "Sau khi The Camellia Sơn Trà mở bán, câu hỏi phổ biến không còn là “dự án đã ra hàng chưa?”, mà là: trong quỹ 469 căn, đâu là loại căn khớp nhu cầu của mình. Ba nhóm được hỏi nhiều nhất là Studio, 1 phòng ngủ + 1 (1PN+1) và 2 phòng ngủ (2PN) — vì đây là các sản phẩm đã công bố mặt bằng và mức giá từ trên trang căn hộ.",
      },
      {
        text: "Bài viết này chỉ dùng số liệu đã có trên site: 469 căn hộ, 25 tầng nổi & 2 hầm, pháp lý sổ hồng sở hữu lâu dài, vị trí giao lộ Lê Văn Lương – Lê Đức Thọ (P. Sơn Trà), giá Studio từ 1,98 tỷ, 1PN+1 từ 3,28 tỷ, 2PN từ 3,90 tỷ. Không suy diễn chính sách từng đợt hay tồn kho cụ thể — khi chọn căn, anh chị nên đối chiếu bảng giá và giỏ hàng tại thời điểm tư vấn.",
        links: [
      ...
      {
        text: "Ngược lại, nếu đã có kế hoạch gia đình nhỏ cần phòng ngủ tách biệt hoặc khu đa năng làm việc cố định, nên xem tiếp 1PN+1 hoặc 2PN thay vì ép không gian Studio. Giá và hướng view vẫn thay đổi theo tầng — hãy nêu ngân sách và tầng mong muốn khi inbox để tư vấn viên lọc giỏ.",
      },
      {
        heading: "1PN + 1 (từ 3,28 tỷ): ở một mình thoải mái hoặc làm việc tại nhà",
        text: "Căn 1 phòng ngủ + 1 có diện tích thông thủy 47,0 m² (mã CH-06), tầng 3A đến 23, mức từ 3,28 tỷ theo công bố. Điểm khác Studio là khu đa năng kèm bếp mở — hữu ích khi cần góc làm việc, tủ đồ hoặc chỗ ngủ phụ linh hoạt mà chưa muốn nhảy lên căn 2 phòng ngủ.",
      },
      {
      ...
      {
        text: "Lưu ý: 2PN có dải diện tích rộng; hai mã cùng “2PN” có thể khác nhau rõ về thông thủy và hướng. Đừng chọn chỉ vì nhãn loại căn — hãy đối chiếu mã căn, NTA/GFA trên trang căn hộ, rồi nhờ tư vấn viên khớp giỏ theo tầng và view.",
      },
      {
      ...
      {
        heading: "CTA — rà giỏ hàng qua Zalo 0934 885 108",
        text: "Inbox Zalo 0934 885 108 (cùng hotline) với mẫu ngắn: ở hoặc đầu tư · loại căn (Studio / 1PN+1 / 2PN) · ngân sách · tầng / hướng view ưu tiên. Tư vấn viên sẽ đối chiếu giỏ hàng và bảng giá cập nhật theo đợt — không cần tự lọc giữa hàng trăm căn.",
        links: [
          { to: "/lien-he", label: "Trang liên hệ" },
